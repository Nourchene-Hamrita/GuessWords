...
public class SearchingWordList : MonoBehaviour
{
    ...
    private bool ShouldScaleDown(Vector3 targetScale)
    {
        ...
        //Make sure that all the  square fit in the parent rectangle area
    ...
    private Vector2 GetFirstSquarePosition()
    {
        ...
        //Make sure that they are in the center

        var shiftBy = (parentRect.rect.width - (squareSize.y * _rows)) / 2;
