...
public class WordsGrid : MonoBehaviour
{
    ...
    private Vector2 GetFirstSquarePosition()
    {
        ...
        var midWithPosition=(((currentGameData.selectedBoardData.columns-12)*squareSize.x)/4)*0.01f;
        var midWithHeight = (((currentGameData.selectedBoardData.rows -12)* squareSize.y) /4) * 0.01f;

        startPosition.x = (midWithPosition != 0) ? midWithPosition * -2 : midWithPosition;
        startPosition.y += midWithHeight*-1;
