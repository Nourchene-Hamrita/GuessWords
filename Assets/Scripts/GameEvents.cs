...
public static class GameEvents 
{
    ...
    public static event ClearSquare OnClearSelection;

    public static void ClearSquareMethod()
    {
    ...
    public delegate void ToggleSoundEffects();
    public static event ToggleSoundEffects OnToggleSoundEffects;

    public static void ToggleSoundEffectsMethod()
    {
        if (OnToggleSoundEffects != null)
        {
